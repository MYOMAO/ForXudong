...
Initialdir=/sphenix/user/zshi/LightFlavor/JobSub
...
#Output=/tmp
Output=/sphenix/user/zshi/LightFlavor/JobSub/out/job.$(Cluster).out
...
Error=/sphenix/user/zshi/LightFlavor/JobSub/err/job.$(Cluster).err
...
Log=/sphenix/user/zshi/LightFlavor/JobSub/log/myjob.$(Cluster).log
